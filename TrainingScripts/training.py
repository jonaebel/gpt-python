...
data_path = BASE_DIR / "Data" / "V2" / "cleanedtxt" / "merged.txt"
tokenizer_dir = BASE_DIR / "Tokenizer"
tokenizer_model = tokenizer_dir / "chat.model"
...
if not tokenizer_model.exists():
    spm.SentencePieceTrainer.Train(
        input=str(data_path),
        model_prefix=str(tokenizer_dir / "chat"),
        vocab_size=1000,
...
for iter in range(max_iters):
    ...
    if iter % eval_interval == 0 or iter == max_iters - 1:
        ...
        }, BASE_DIR / "LLM" / f"checkpoint_{iter}.pth")
